/*
 * Implementação de um algoritmo de ordenação seleção direta
 * 
 * Essa tipo de algoritmo (classificação por seleção) é um dos mais simples
 * e realiza a ordenação com a seleção sucessiva de menores (ou maiores) elementos.
 * 
*/
